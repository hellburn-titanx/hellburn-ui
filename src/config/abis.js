...
export const GENESIS_ABI = [
  ...
  "function endGenesis(uint256 minWETHOut)",
  "function collectLPFees(address buyAndBurn)",
  ...
  "function effectiveUserPercent() view returns (uint256)",
  "function lpInfo() view returns (bool created, uint256 tokenId, uint256 reserveHBURN, uint256 fundTitanX)",
